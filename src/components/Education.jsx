...
//           <p className="text-indigo-400 text-xs font-bold tracking-[0.15em] uppercase mb-3">Background</p>
...
//                 </svg>
//                 Started: December 31, 2025 &nbsp;·&nbsp; In Progress
//               </p>
//             </div>
//           </div>

//           {/* Ostad MERN Certificate */}
//           <div className="bg-slate-900/70 border border-white/6 rounded-2xl p-8 md:p-10 flex gap-6 items-start glow-border hover:-translate-y-1 transition-transform duration-300">
...
//                   <div
//                     key={label}
//                     className="bg-teal-500/8 border border-teal-500/20 rounded-xl px-4 py-2 text-center"
//                   >
